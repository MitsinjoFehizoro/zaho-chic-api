...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests.requestMatchers(apiPrefix + "/user/**",apiPrefix + "/products/get/**", apiPrefix + "/categories/get/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173")); // Remplace par l’URL de ton frontend
